...
export const productsCache = async (req:Request,res:Response,next:NextFunction) =>{   
...
export const categoriesCache = async(req:Request,res:Response,next:NextFunction) =>{
...
export const productDetailCache = async(req:Request,res:Response,next:NextFunction) =>{
...
export const cartCache = async(req:Request,res:Response,next:NextFunction) =>{
